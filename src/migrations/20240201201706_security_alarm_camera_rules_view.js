exports.up = function (knex) {
  return knex.raw(`
    ...
    select
      ...
      cc.connection_type,
      cast(json_unquote(json_extract(cc.connection_params, '$.camera_id')) as varchar(65535)) as connection_params_camera_id,
      cast(rr.arm_on as varchar(64)) as arm_on,
